...
GameForest.prototype.onGameChoose   = function ()
{
	...
	getStatVal(xWins, statValList, statNameList, cbStat); 
	getStatVal(oWins, statValList, statNameList, cbStat); 
